...
# S T A T U T
## Студентске организације Протон Електротехничког факултета у Београду
...
## Član 4.
* Naziv Udruženja utvrđuje se kao: Студентска организација Протон Електротехничког факултета у Београду.
* Skraćeni naziv utvrđuje se kao: Протон.
* Naziv Udruženja na engleskom jeziku utvrđuje se kao: Student organization Proton School of Electrical Engineering Belgrade.
...
* Preduzimaju se potrebne mere radi obezbeđivanja javnosti rada i informisanosti članstva i studenata.
* Za informisanje se koriste sredstva javnog informisanja, izveštaji, bilteni, oglasne i elektronske oglasne table, veb-prezentacija Udruženja i nalozi na društvenim mrežama.
* Mere radi obezbeđivanja javnosti i informisanosti o radu Udruženja preduzimaju se kontinuirano od strane Izvršnog odbora.
...
## Član 7.
* Podsticanje i koordinacija aktivnosti članova vrši se u skladu sa Ustavom, Zakonom o udruženjima i drugim zakonskim propisima.
* Misija Udruženja utvrđuje se kao širenje ideje studentskog organizovanja i studenske solidarnosti.
...
## Član 8.
**Radi ostvarivanja ciljeva Udruženja naročito se:**
1. organizuju samostalno ili u saradnji sa drugim organizacijama domaće i međunarodne konferencije, seminari, studentska takmičenja, predavanja stručnjaka, javne tribine i slične aktivnosti;
2. vrši javno istupanje radi propagiranja aktivnosti Udruženja.
...
* Član čije je članstvo zamrznuto gubi sva prava i obaveze koje mu članstvo u Udruženju pruža, ali ne i sam status člana Udruženja.
...
* Član koji prisustvuje sednici Skupštine Udruženja po osnovu navedenom u prethodnom stavu ne ubraja se u kvorum za tu sednicu.

## Član 12a.
* Punopravni član Udruženja koji se ne pojavi na dve uzastopne sednice Skupštine bez opravdanja gubi pravo na učešće u radu Skupštine.
* Generalni sekretar Udruženja je dužan da prati prisutnost članova na sednicama Skupštine i da registruje odsustva u zapisniku sednice.
* Član gubi pravo na učešće odmah nakon nepojavljivanja na drugoj sednici bez opravdanja, što se registruje u zapisniku te sednice od strane Generalnog sekretara.
* Prigovor na gubitak prava na učešće u Skupštini može se podneti Skupštini na narednoj sednici, sa navođenjem valjanog razloga za odsustvo sa prethodnih sednica.
* Skupština odlučuje većinom glasova da li je navedeni razlog validan i da li će se članstvo na učešće u Skupštini vratiti.
* Povratak prava na učešće u Skupštini moguć je samo odlukom Skupštine na redovnoj ili vanrednoj sednici.
...
* Revizija broja članova Skupštine vrši se na početku svake akademske godine, neposredno pred održavanje izbora novih članova Skupštine.
...
## Član 24.
**Isključivo za izvršavanje ciljeva i zadataka propisanih ovim Statutom, bez raspodele članovima, sredstva se mogu sticati:**
...
## Član 26.
* Finansijska sredstva mogu se pribavljati obavljanjem privredne delatnosti bez raspodele dobiti članovima.
...
* O upravljanju ovim prihodima, datumu početka obavljanja delatnosti i preciziranju tačne delatnosti kojom se Udruženje bavi odlučuje se od strane Skupštine Udruženja, u skladu sa finansijskim planom i opštim interesima Udruženja.
...
## Član 27.
* Ovaj Statut usvojen je od strane Skupštine Udruženja.
* Izmene i dopune ovog Statuta vrše se po postupku po kome je Statut donet.
* Izmene i dopune Statuta mogu biti inicirane odlukom Predsednika Upravnog odbora, Predsednika Izvršnog odbora, Generalnog sekretara ili najmanje jedne trećine članova Skupštine Udruženja.
...
* O prestanku rada Udruženja nadležni organ obaveštava se u roku od petnaest dana od dana prestanka rada Udruženja radi brisanja Udruženja iz Registra.
* Obaveštavanje se vrši od strane lica ovlašćenog za predstavljanje i zastupanje.
