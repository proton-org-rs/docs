...
# PRAVILNIK O IZBORU ČLANOVA SKUPŠTINE
...
## Član 3.
* Aktivno biračko pravo za izbor članova Skupštine imaju svi punopravni članovi Udruženja.
* Lista birača sa aktivnim biračkim pravom utvrđuje se na dan raspisivanja izbora.
* Samo punopravni članovi koji su upisani na listu birača mogu učestvovati u glasanju.

## Član 4.
* Pasivno biračko pravo za članstvo u Skupštini imaju svi punopravni članovi Udruženja.
* Kandidat za članstvo u Skupštini mora biti student Elektrotehničkog fakulteta Univerziteta u Beogradu.
...
* Za vanredne izbore, broj mesta utvrđuje se kao broj mesta dostupnih na prethodnim redovnim izborima.
...
## Član 9.
* Glasanje se sprovodi elektronskim putem pomoću elektronske forme za glasanje.
* Elektronska forma omogućava biranje do broja kandidata koliko ima mesta u Skupštini.
* Svaki birač može glasati za maksimalno onoliko kandidata koliko ima mesta u Skupštini.
* Period glasanja traje tri dana.
* Glasanje je tajno i anonimno.
* Birač može promeniti svoj glas tokom perioda glasanja, pri čemu važi poslednji uneti glas.
* Generalni sekretar je dužan da obezbedi tehničku infrastrukturu za sprovođenje elektronskog glasanja koja garantuje tajnost, bezbednost i transparentnost procesa.
...
* U slučaju jednakog broja glasova za poslednje mesto u Skupštini, odlučujući kriterijum je prosečna ocena tokom studija, a zatim staž članstva u Udruženju.
...
## Član 11.
* Generalni sekretar utvrđuje rezultate izbora u roku od dvadeset četiri časa od zatvaranja glasanja.
* Rezultati izbora sadrže: ukupan broj birača, broj glasova, broj važećih glasova, listu izabranih članova Skupštine sa brojem glasova koje je svaki dobio.
* Rezultati se objavljuju putem zvanične mejling liste, veb-prezentacije Udruženja, i drugih komunikacionih kanala.
* Generalni sekretar obaveštava sve kandidate o rezultatima izbora elektronskim putem.
